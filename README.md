...
**MTU-JSON-GUI** 是一款专为日漫汉化器 https://github.com/hgmzhn/manga-translator-ui https://gitee.com/hgmzhn/manga-translator-ui量身定制的 Web 端可视化嵌字工具。它不仅能处理文本替换，更内置了一套精密平衡的**几何排版引擎**，旨在通过算法自动化解决日漫排版中繁琐的对齐、间距与透视问题。
